...
const styles = StyleSheet.create({
  scoreBoard: { flexDirection: 'row', justifyContent: 'space-between', padding: 20, alignItems: 'center' },
  teamInfo: { flexDirection: 'column' },
  teamName: { fontSize: 20, fontWeight: 'bold' },
  runsovers: { flexDirection: 'row' },
  runs: { fontSize: 18, fontWeight: 'bold', color: '#333', marginRight: 5 },
  overs: { fontSize: 18, fontWeight: 'bold', color: '#666' },
  runRate: { fontSize: 18, color: '#666' },
});
